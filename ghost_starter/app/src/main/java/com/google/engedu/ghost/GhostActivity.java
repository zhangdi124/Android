...
public class GhostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            dictionary = new FastDictionary(inputStream);//instantiate a FastDictionary instead of a SimpleDictionary
        } catch (IOException e) {
...
//        Log.d("Testing yummy", dictionary.isWord("yummy") + "");
//        Log.d("Testing yucky", dictionary.isWord("yucky") + "");
//        Log.d("Testing zebras", dictionary.isWord("zebras") + "");
//        Log.d("Testing booboos", dictionary.isWord("booboos") + "");
